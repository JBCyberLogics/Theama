  ...
  if (movies.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 sm:py-20 text-center">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#3D0000" strokeWidth="1" className="mb-4">
          <rect x="2" y="2" width="20" height="20" rx="2" />
          <path d="M8 2v20M16 2v20M2 8h20M2 16h20" />
        </svg>
        <p className="font-['Cormorant_Garamond'] italic text-[#B38080] text-[16px] sm:text-[18px]">
          {emptyMessage}
        </p>
      </div>
    )
